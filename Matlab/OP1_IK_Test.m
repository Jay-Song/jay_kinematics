...
link(3).relative_position = [0;  0;       0]; link(3).joint_angle = 0; link(3).joint_axis = [0; 1; 0]; link(3).joint_dir = 1; link(3).pos = [0; 0; 0]; link(3).rot = eye(3);
link(4).relative_position = [0;  0;  -0.093]; link(4).joint_angle = 0; link(4).joint_axis = [0; 1; 0]; link(4).joint_dir = 1; link(4).pos = [0; 0; 0]; link(4).rot = eye(3);
link(5).relative_position = [0;  0;  -0.093]; link(5).joint_angle = 0; link(5).joint_axis = [0; 1; 0]; link(5).joint_dir = 1; link(5).pos = [0; 0; 0]; link(5).rot = eye(3);
...
link(7).relative_position = [0;  0; -0.0335]; link(7).joint_angle = 0; link(7).joint_axis = [0; 0; 0]; link(7).joint_dir = 1; link(7).pos = [0; 0; 0]; link(7).rot = eye(3);
