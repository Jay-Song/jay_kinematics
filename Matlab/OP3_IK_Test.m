...
link(3).parent =  2; link(3).child =  4; link(3).sibling = -1; link(3).relative_position = [0.0001;  0;        0]; link(3).joint_angle = 0; link(3).joint_axis = [0; 1; 0]; link(3).pos = [0; 0; 0]; link(3).rot = eye(3);
link(4).parent =  3; link(4).child =  5; link(4).sibling = -1; link(4).relative_position = [0.0001;  0; -0.11015]; link(4).joint_angle = 0; link(4).joint_axis = [0; 1; 0]; link(4).pos = [0; 0; 0]; link(4).rot = eye(3);
link(5).parent =  4; link(5).child =  6; link(5).sibling = -1; link(5).relative_position = [0;       0;    -0.11]; link(5).joint_angle = 0; link(5).joint_axis = [0; 1; 0]; link(5).pos = [0; 0; 0]; link(5).rot = eye(3);
...
link(7).parent =  6; link(7).child = -1; link(7).sibling = -1; link(7).relative_position = [0;       0;  -0.0305]; link(7).joint_angle = 0; link(7).joint_axis = [0; 0; 0]; link(7).pos = [0; 0; 0]; link(7).rot = eye(3);
